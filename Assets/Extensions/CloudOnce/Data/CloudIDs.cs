...
namespace CloudOnce
{
    ...
    public static class CloudIDs
    {
        ...
        {
            public static string ClimbModeLeaderboard
            {
                get
                {
#if UNITY_ANDROID && !UNITY_EDITOR
#if CLOUDONCE_GOOGLE
                    return "CggI-9Dc8x0QAhAB";
#else
                    return string.Empty;
#endif
            ...
            public static string ClassicModeLeaderboard
            {
                get
                {
#if UNITY_ANDROID && !UNITY_EDITOR
#if CLOUDONCE_GOOGLE
                    return "CggI-9Dc8x0QAhAC";
#else
                    return string.Empty;
#endif
#elif (UNITY_IOS || UNITY_TVOS) && !UNITY_EDITOR
